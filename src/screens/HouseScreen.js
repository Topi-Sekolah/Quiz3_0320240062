...
export default function HouseScreen({ navigation }) {
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener('focus', fetchHouses);
    return unsubscribe;
  }, [navigation]);
        ...
        <View style={styles.mainContent}>
          ...
          {loading ? (
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <Text style={styles.empty}>Tidak ada data House.</Text>
              }
            />
          )}
          ...
          <View style={styles.bottomTab}>
            ...
            >
              <Text style={styles.bottomBtnText}>Apart</Text>
            </TouchableOpacity>
            {/* House aktif */}
            <View style={[styles.bottomBtn, styles.bottomBtnActive]}>
              <Text style={styles.bottomBtnTextActive}>House</Text>
            </View>
          </View>
        </View>
      </View>
